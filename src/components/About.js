...
function About() {
  return (
    <div className="flex flex-col items-center justify-center w-full overflow-hidden sm:gap-2">
      <div className="flex flex-col w-full max-w-4xl text-justify items-center justify-center  p-3 pt-20 lg:p-10 lg:pt-24 rounded-lg shadow-[0_35px_35px_-20px_rgba(0,128,128,0.3)] overflow-y-auto sm:gap-2">

        <div className="flex flex-col lg:flex-row w-full gap-2 lg:gap-5 sm:gap-2">
          <div className="w-full lg:w-1/2 mt-[-0.2rem]">
          ...
          <div className="w-full lg:w-1/2 mt-[-0.5rem]">
        ...
        <button
          type="button"
          className="transition-all my-3  w-full h-16 text-neutral-50 bg-purple-500 hover:bg-yellow-400 hover:text-neutral-50 rounded-full"
        >
          <a
            href="#contact"
